...
<head>
    ...
    <link rel="stylesheet" href="../css/iniciarconsulta.css">
      ...
      <div class="container">
          ...
          <div class="collapse navbar-collapse " id="navbarNav">
            <ul class="navbar-nav mx-auto">
              ...
              <li class="nav-item">
                <a class="nav-link fs-6 navbar-brand active" href="#" >INICIAR CONSULTA</a>
              </li>
              <li class="nav-item">
        ...
        <div class="info-text">
          ...
          <p class="p-objetivos" class="text-center text-wrap" >Lorem ipsum dolor sit amet, consectetur adipiscing elit, 
            ...
            mollit anim id est laborum</p>
             ...
             <div class="bntsPrinc">
                  <a href="Nutrición.html"><button>Ingresar</button></a>
              </div>
